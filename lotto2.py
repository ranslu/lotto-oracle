...
st.markdown("""
<link rel="manifest" href="data:application/json,{&quot;name&quot;:&quot;Lotto Oracle&quot;,&quot;short_name&quot;:&quot;Lotto Oracle&quot;,&quot;start_url&quot;:&quot;/&quot;,&quot;display&quot;:&quot;standalone&quot;,&quot;background_color&quot;:&quot;#040D18&quot;,&quot;theme_color&quot;:&quot;#00F5FF&quot;,&quot;icons&quot;:[{&quot;src&quot;:&quot;https://i.postimg.cc/rsWKKnwN/lotto-oracle-icon-1.png&quot;,&quot;sizes&quot;:&quot;1024x1024&quot;,&quot;type&quot;:&quot;image/png&quot;}]}">
<meta name="mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
<meta name="apple-mobile-web-app-title" content="Lotto Oracle">
<meta name="theme-color" content="#00f0ff">
<link rel="apple-touch-icon" href="https://i.postimg.cc/rsWKKnwN/lotto-oracle-icon-1.png">
<link rel="icon" type="image/png" href="https://i.postimg.cc/rsWKKnwN/lotto-oracle-icon-1.png">
<script>
...
def fetch_daily_grand():
    """Fetch Daily Grand results from multiple sources with fallbacks."""
    import re
    ...
    try:
        ...
        for row in soup.select("table tr"):
            ...
            draw_date = try_parse_date(cells[0].get_text(strip=True))
            if not draw_date: continue
            all_nums = [int(x) for x in re.findall(r"\d{1,2}", cells[1].get_text())]
            grand_nums = [int(x) for x in re.findall(r"\d{1,2}", cells[2].get_text())]
            if len(all_nums) == 5:
                grand = grand_nums[0] if grand_nums else 0
                draws.append((draw_date, sorted(all_nums), grand))
    except Exception:
        pass
    ...
    if not draws:
        try:
            ...
            for row in soup3.select("table tr"):
                ...
                draw_date = try_parse_date(cells[0].get_text(strip=True))
                if not draw_date: continue
                all_nums = [int(x) for x in re.findall(r"\d{1,2}",
                            " ".join(c.get_text() for c in cells[1:]))]
                if len(all_nums) >= 5:
    ...
    if not draws:
        return [], "Unable to fetch Daily Grand — all sources failed. Using built-in data."
    ...
    return clean[:60], f"Fetched {len(clean[:60])} draws · latest: {clean[0][0]}"
